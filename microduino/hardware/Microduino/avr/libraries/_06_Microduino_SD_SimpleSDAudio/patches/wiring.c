...
Patched that timer2 will do the timing stuff insted of timer0
...
void init()
{
	...
	sei();
		...
		sbi(TCCR2, CS20);
		sbi(TCCR2, CS21);
	#elif defined(TCCR2) && defined(CS22) && defined(CS20)
		// this combination is for the standard atmega8
		sbi(TCCR2, CS22);
	#elif defined(TCCR2B) && defined(CS22) && defined(CS20)
	...
	#ifndef TIMER0_ISFREE
		#define TIMER0_ISFREE	1
	#endif
#else
