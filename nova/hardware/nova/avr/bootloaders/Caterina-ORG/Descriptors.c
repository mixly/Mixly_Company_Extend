...
const USB_Descriptor_String_t ProductString =
{
	...
	#elif DEVICE_PID == 0x0041
	.UnicodeString			= L"Arduino Yun          "
	#elif DEVICE_PID == 0x0038
	.UnicodeString			= L"Arduino Robot-Control"
	#elif DEVICE_PID == 0x0039
	.UnicodeString			= L"Arduino Robot-Motor  "
	#elif DEVICE_PID == 0x0050
	.UnicodeString			= L"Arduino Yun-Mini     "
...
const USB_Descriptor_String_t ManufNameString = 
{
	...
	#if (DEVICE_VID == 0x2A03)
	.UnicodeString			= L"Arduino srl  "
